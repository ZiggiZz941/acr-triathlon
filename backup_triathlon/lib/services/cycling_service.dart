...
class CyclingService {
  static const String _fileName = "cycling_seances.json";
  ...
  Future<bool> saveSeance(TriathlonSeance seance) async {
    try {
      ...
      print("Erreur sauvegarde séance cyclisme: $e");
      return false;
    }
  }
  ...
  Future<List<TriathlonSeance>> loadAllSeances() async {
    try {
      ...
      return jsonArray
          ...
          .where((seance) => seance.sportType == SportType.cycling)
          .toList();
    } catch (e) {
      print("Erreur chargement séances cyclisme: $e");
      return [];
    }
  }
  ...
  Future<bool> deleteSeance(int seanceId) async {
    try {
      ...
      print("Erreur suppression séance cyclisme: $e");
      return false;
    }
  }
  ...
  Future<bool> _saveAllSeances(List<TriathlonSeance> seances) async {
    try {
      ...
      print("Erreur sauvegarde toutes séances cyclisme: $e");
      return false;
    }
  }
  ...
  Future<Map<String, dynamic>> getStats() async {
    ...
    double totalWatts = seances.fold(0.0, (sum, seance) {
      return sum +
          seance.exercices
    ...
    return {
      ...
      'moyenneWatts': totalExercices > 0 ? totalWatts / totalExercices : 0,

...
class SwimmingService {
  static const String _fileName = "swimming_seances.json";
  ...
  Future<bool> saveSeance(TriathlonSeance seance) async {
    try {
      ...
      print("Erreur sauvegarde séance natation: $e");
      return false;
    }
  }
  ...
  Future<List<TriathlonSeance>> loadAllSeances() async {
    try {
      ...
      print("Erreur chargement séances natation: $e");
      return [];
    }
  }
  ...
  Future<bool> deleteSeance(int seanceId) async {
    try {
      ...
      print("Erreur suppression séance natation: $e");
      return false;
    }
  }
  ...
  Future<bool> _saveAllSeances(List<TriathlonSeance> seances) async {
    try {
      ...
      print("Erreur sauvegarde toutes séances natation: $e");
      return false;
    }
  }
